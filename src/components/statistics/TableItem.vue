  ...
  >
    <div class="min-w-0 flex-1">
      ...
      <div class="w-[60%]">
        <p>
          ...
          Exercitationem et corrupti qui quis ad blanditiis, velit culpa
    ...
    <div class="mt-5 flex lg:ml-4 lg:mt-0">
      ...
      <span class="sm:ml-3">
        <button
          type="button"
          class="inline-flex items-center rounded-md bg-current/50 bg-indigo-600 px-3 py-2 text-sm font-semibold shadow-sm hover:bg-green"
        >
